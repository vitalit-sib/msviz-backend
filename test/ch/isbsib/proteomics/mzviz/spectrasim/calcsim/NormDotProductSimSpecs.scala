...
class NormDotProductSimSpecs extends Specification {
  ...
  "compute normalized dot product" should {
    ...
    val mzs = List(532.2181757006471, 592.0813696890917, 610.4389304593608, 819.528204667349, 1008.9731541854521, 1114.2026733872658, 1228.8277418928208, 1250.291877455562, 1458.4947369611507, 1617.97592028064, 1673.0009209859188, 1711.5858053298323, 1900.6064002325252, 1978.9769588099969, 2004.1818947649767, 2121.1340129945756, 2242.9549664843066, 2268.9075118303103, 2297.4721551530297, 2348.226927064944)
    val int1 = List(5.0, 8.0, 11.0, 7.0, 6.0, 21.0, 11.0, 2.0, 15.0, 14.0, 23.0, 4.0, 7.0, 18.0, 1.0, 26.0, 3.0, 24.0, 6.0, 12.0)
    val int2 = List(6.0, 9.0, 21.0, 20.0, 1.0, 23.0, 9.0, 1.0, 7.0, 26.0, 12.0, 16.0, 9.0, 5.0, 7.0, 2.0, 9.0, 9.0, 5.0, 28.0)

    // prepare spectra
    def prepSp(mzs: List[Double], ints: List[Double]): ExpMSnSpectrum ={
      val prec1 = ExpPeakPrecursor(Moz(100.1), Intensity(1000), RetentionTime(10.0), Charge(1), None, Some(MolecularMass(99.09272)), Some("test"))
