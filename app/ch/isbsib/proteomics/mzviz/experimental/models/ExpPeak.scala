...
case class ExpPeakPrecursor(moz: Moz, intensity: Intensity, retentionTime: RetentionTime, charge: Charge, scanNumber:Option[ScanNumber], molecularMass: Option[MolecularMass]) extends ExpPeak{
